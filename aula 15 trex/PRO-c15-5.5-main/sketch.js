...
var gameover, saveGameover;

var restart, saveRestart;
...
function preload(){
  ...
  saveGameover = loadImage("gameOver.png");
  saveRestart = loadImage("restart.png");
...
function setup() {
  ...
  gameover.addImage(saveGameover);
  gameover.scale = 0.5;
  gameover.visible = false;


  restart = createSprite(300,140);
  restart.addImage(saveRestart);
  restart.scale = 0.5;
